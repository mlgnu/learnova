...
import org.mlgnu.learnova.module.auth.model.JwtToPrincipalConverter;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtToPrincipalConverter jwtToPrincipalConverter)
            throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .oauth2ResourceServer(
                        oauth -> oauth.jwt(jwt -> jwt.jwtAuthenticationConverter(jwtToPrincipalConverter)))
                .build();
    }
